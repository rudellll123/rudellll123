...
<h3 align="center">AI/ML Engineer • Full-Stack Developer • RAG, Computer Vision & Agentic Systems</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=16&duration=2600&pause=900&color=A855F7&width=520&lines=CS+Undergrad+%40+SRM+IST;Building+production-style+AI%2FML+systems;RAG+%7C+Computer+Vision+%7C+Agentic+AI" alt="typing" />
</p>

<p align="center">
  CS undergraduate building production-style AI/ML, RAG, and full-stack systems with Python, FastAPI, and React.
</p>
...
Real-time PPE, personnel, and vehicle detection system for construction-site safety monitoring, with automated incident capture.

- 📈 Improved detection from **41.1% → 70% mAP@50** (75% precision, 65% recall) across 25 classes by training and iterating a **YOLO26n** model
- 🎯 Added **ByteTrack** multi-object tracking with sub-10ms inference latency
- 🚨 Automated PPE-violation/incident detection with timestamped evidence capture
- 🖥️ Shipped a **React + FastAPI + PostgreSQL** dashboard for incident review, containerized with **Docker**
...
[**🔗 View Code**](https://github.com/rudellll123)
...
API that grounds AI-generated answers strictly in uploaded document content, reducing hallucination.

- 🧩 Designed the full pipeline — chunking, local embeddings (**sentence-transformers**), **ChromaDB** vector search, and answer generation via the **Anthropic Claude API**
- 🔐 Secured the platform with **JWT + bcrypt** authentication and per-user data isolation
- 🐳 Containerized the **FastAPI + PostgreSQL** stack with **Docker Compose** for one-command deployment
...
<img src="https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white" />
<img src="https://img.shields.io/badge/ChromaDB-black?style=flat-square" />
<img src="https://img.shields.io/badge/sentence--transformers-black?style=flat-square" />
...
Channel-agnostic voice assistant (web dashboard, Twilio phone/IVR, local mic demo) letting farmers ask market-price, trend, and weather questions in Hindi, Marathi, or English and hear spoken answers back. Built during my internship at **Siddharth Infosys**.

- ⚡ Cut government market-price data retrieval from **10+ seconds to under 0.4 seconds** with in-memory caching over the Agmarknet (data.gov.in) API
- 🗣️ Integrated **Gemini 2.0 Flash** for intent/entity extraction with a rule-based fallback NLU
- 📊 Built a **linear regression** trend-forecasting engine with R² confidence scoring, plus OpenWeatherMap for hyper-local weather queries
...
My flagship agentic AI project — ties my existing computer vision, RAG, and backend work into one pipeline that reads documents, watches video, listens to audio, and reasons across all of it to investigate incidents and draft a report for human review.

- 🧠 **Orchestration:** LangGraph supervisor agent routing to specialized RAG, vision, data, knowledge-graph, and report agents
- 🔍 **Retrieval:** Hybrid search (dense embeddings + BM25 + reranking) over Qdrant, plus Neo4j for relationship-aware reasoning
- 👁️ **Vision:** YOLO + ByteTrack + VLM-based scene understanding, extending my surveillance pipeline above
- 🎙️ **Audio:** Whisper speech-to-text with TTS for voice-driven queries
- ⚙️ **Infra:** FastAPI, PostgreSQL, Redis + Celery, Docker + GitHub Actions, deployed on AWS (S3/ECR/ECS/RDS)
- 📊 **Reliability:** RAG/agent evaluation, OpenTelemetry tracing, Prometheus + Grafana dashboards
- ✅ Human approval stays in the loop — this is an AI-assisted investigation tool, not an autonomous decision-maker
...
[**🔗 Repo (coming soon)**](https://github.com/rudellll123)
...
- Selected Participant — Guidewire DevTrails & Study AI Launch Pad
...
<p align="center">
  <a href="mailto:rahuljha1807@gmail.com"><img src="https://github.com/tandpfun/skill-icons/raw/main/icons/Gmail-Dark.svg" width="52"></a>
  <a href="https://www.linkedin.com/in/rahuljha174/"><img src="https://github.com/tandpfun/skill-icons/raw/main/icons/LinkedIn.svg" width="52"></a>
  <a href="https://github.com/rudellll123"><img src="https://github.com/tandpfun/skill-icons/raw/main/icons/Github-Dark.svg" width="52"></a>
  <a href="https://leetcode.com/u/rahuljha1807/"><img src="https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/leetcode.svg" width="30" style="background-color:#1a1a1a;border-radius:8px;padding:11px;"></a>
</p>

<p align="center">🌍 Chennai, India · Open for relocation</p>
